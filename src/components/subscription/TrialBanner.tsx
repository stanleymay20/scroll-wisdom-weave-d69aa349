...
export const TrialBanner = forwardRef<HTMLDivElement>(
  function TrialBanner(_props, ref) {
    ...
    return (
      <div ref={ref} className="relative overflow-hidden border-b border-primary/20 mt-16 bg-gradient-to-r from-emerald-500/10 via-primary/5 to-emerald-500/10">
