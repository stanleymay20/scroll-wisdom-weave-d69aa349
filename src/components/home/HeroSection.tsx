      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <br />
            <span className="text-gradient-gold">Infinite Library</span>
          </motion.h1>
          ...
          >
            Generate unlimited books across theology, science, history, and beyond. 
            Each with chapters of 8,000+ words, scroll-aligned accuracy, and academic rigor.
          </motion.p>
