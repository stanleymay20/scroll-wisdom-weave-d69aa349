...
import { Upload, BookOpen, CheckCircle, ChevronDown } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-start max-w-6xl mx-auto">
          ...
          <div className="pt-4">
            ...
            <motion.p
              ...
              className="text-base text-muted-foreground mb-7 leading-relaxed max-w-lg"
            >
              ...
              <div className="bg-muted/50 rounded-lg p-3 flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Drag your book or choose to upload
                  </p>
                </div>
            ...
            <div className="bg-card/90 backdrop-blur-sm border border-border rounded-xl p-5 shadow-sm">
              ...
              <div className="space-y-1.5 text-sm text-muted-foreground mb-3">
                <p className="flex items-center gap-2">
                  <span className="text-primary">○</span> Choose one of the
                  following...
                </p>
                <p className="flex items-center gap-2">
                  <span className="text-primary">□</span> While working on a
                  research test...
                </p>
                <p className="flex items-center gap-2">
                  <span className="text-primary">□</span> Describe the process
                  of...
                </p>
                <p className="flex items-center gap-2">
                  <span className="text-primary">◆</span> The salients of
