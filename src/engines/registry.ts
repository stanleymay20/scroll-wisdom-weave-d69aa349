...
export const ENGINE_REGISTRY: Record<string, EngineManifest> = {
  ...
  ScrollInstitution: {
    ...
    capabilities: [
      ...
      'Bulk roster provisioning with institution-scoped roles',
    ...
    gaps: [
      'Reconcile and schema-control the existing 1,560-row legacy public.courses catalogue in the live Supabase project',
      ...
      'Deploy and verify the new university migrations and Edge Functions against the live ScrollUniversity Supabase project',
