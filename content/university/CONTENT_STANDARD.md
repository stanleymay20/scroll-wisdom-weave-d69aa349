...
1. Course specification
   - code, title, level, credits, delivery mode and workload
...
## Credit and workload rule

For courses represented in ECTS, ScrollUniversity uses the European Commission ECTS workload convention as the planning baseline: a typical credit represents approximately 25–30 hours of learner workload and a full-time academic year normally represents 60 ECTS.

A 5 ECTS course therefore plans approximately **125–150 total learner hours**, including guided study, readings, practice, assessment preparation and independent work. The repository validator checks that declared workload is consistent with this range.
...
- credits > 0
- planned workload between credits × 25 and credits × 30 hours
