-- Lovable Test convergence Phase 8: certified manuscript/design integrity.
--
-- Final-state convergence only. It binds design settings into the current
-- publication hash and prevents a certified live manuscript from drifting.
