  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        scroll: {
          gold: "hsl(var(--scroll-gold))",
          "gold-light": "hsl(var(--scroll-gold-light))",
          "gold-dark": "hsl(var(--scroll-gold-dark))",
          indigo: "hsl(var(--scroll-indigo))",
          "indigo-deep": "hsl(var(--scroll-indigo-deep))",
          cream: "hsl(var(--scroll-cream))",
          "cream-dark": "hsl(var(--scroll-cream-dark))",
          bronze: "hsl(var(--scroll-bronze))",
        },
        sidebar: {
